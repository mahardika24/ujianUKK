...
<h1 class="text-gray-600 font-semibold text-lg flex justify-center">Laporan Menu</h1>
...
<table id="barangTable" class="table-auto  w-full mx-10 border-collapse">
        ...
        <tr class=" text-[#595959] font-medium text-sm">
                ...
                <th class="px-4 border border-[#8E8E8E] text-start py-2">Nama Produk</th>
                <th class="px-4 border border-[#8E8E8E] text-start py-2">Harga</th>
                <th class="px-4 border border-[#8E8E8E] text-start py-2">Stok</th>
            </tr>
        </thead>
        <tbody>
             ...
             <?php
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td class='border border-[#8E8E8E] border-b font-medium text-[#616161] text-sm px-4 py-2 text-center'>" . $row['namaProduk'] . "</td>";
                            echo "<td class='border border-[#8E8E8E] border-b font-medium text-[#616161] text-sm px-4  py-2'>" . $row['harga'] . "</td>";
                            echo "<td class='border border-[#8E8E8E] border-b font-medium text-[#616161] text-sm px-4  py-2'>" . $row['stok'] . "</td>";
